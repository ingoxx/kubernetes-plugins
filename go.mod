module github.com/ingoxx/kubernetes-plugins

go 1.24.0

toolchain go1.24.7

// 确保所有 k8s.io/kubernetes 的内部依赖都被正确解析
...
replace (
	...
	k8s.io/klog/v2 => k8s.io/klog/v2 v2.100.1 // 确保 klog 也是一个明确的版本
	k8s.io/kube-scheduler => k8s.io/kube-scheduler v0.29.0
	// 强制 k8s.io/kubernetes 使用明确的版本
